...
//   }
  ...
  _getRenderSource(indent = "") {
    ...
    return [
      ...
      `${childIndent}function createElement(type, props, ...children) { `,
      `${childIndent}  const component = oak.lookupComponent(type, components, "${errorMessage}");`,
      `${childIndent}  return React.createElement(component, props, ...children);`,
      `${childIndent}}`,
      "",
